...
{
    /// <inheritdoc />
    public partial class AddOrganizationDomainAndAuthFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAuthProviders = table.Column<string[]>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentOrganizationId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnpaidBalance = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalPaidOut = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Consigners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Consigners_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ConsignerPayouts",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ConsignerId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsignerPayouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsignerPayouts_Consigners_ConsignerId",
                        column: x => x.ConsignerId,
                        principalTable: "Consigners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsignerPayouts_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsignerId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Items_Consigners_ConsignerId",
                        column: x => x.ConsignerId,
                        principalTable: "Consigners",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsignerPayouts_ConsignerId",
                table: "ConsignerPayouts",
                column: "ConsignerId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsignerPayouts_OrganizationId",
                table: "ConsignerPayouts",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Consigners_OrganizationId",
                table: "Consigners",
                column: "OrganizationId");
